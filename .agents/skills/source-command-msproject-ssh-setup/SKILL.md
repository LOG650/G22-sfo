---
name: "source-command-msproject-ssh-setup"
description: "Hjelp brukeren sette opp SSH-tilgang til Windows-VMen for MS Project-automasjon"
---

# source-command-msproject-ssh-setup

Use this skill when the user asks to run the migrated source command `msproject-ssh-setup`.
